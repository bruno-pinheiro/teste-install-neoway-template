...
sphinx-apidoc -f -e -o docs/source/apidoc/ teste_install_neoway_template/
...
sed -i '0,/teste_install_neoway_template/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i '0,/project/s//teste_install_neoway_template/' docs/source/index.rst
# Generate html docs
make -C docs/ html
