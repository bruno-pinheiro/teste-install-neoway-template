IMAGE = teste-install-neoway-template
PACKAGE = teste_install_neoway_template
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ teste_install_neoway_template <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf teste_install_neoway_template.egg_info
